...
I had the opportunity to collaborate with the following distinguished faculty members.
  \begin{enumerate}
	...
	\item Dr. Niladri Sett, Research Associate, UCD Ireland
  \end{enumerate}
\section{Reference Persons}
  \begin{enumerate}
  \item Prof. Sukumar Nandi, Senior Professor\\Department of CSE, IIT Guwahati, sukumar@iitg.ac.in, (+91~361~258~2357)
  \item Prof. Soumya Kanti Ghosh, Professor\\Department of CSE, IIT Kharagpur, skg@cse.iitkgp.ac.in, (+91~322~228~2332)
  \item Dr. Sandip Chakraborty, Assistant Professor\\Department of CSE, IIT Kharagpur, sandipc@cse.iitkgp.ac.in, (+91~322~228~2898)
  \end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \nocite{*}
